		...
		<form action="" method="get">
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<?php $selectTraining->displayHTML(); ?>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="tra_name">Trainer</label>
						<input type="text" class="form-control" name="tra_name" id="tra_name" placeholder="Lname" value="<?= $studentObject->getLocation() ?>">
					</div>
				</div>
